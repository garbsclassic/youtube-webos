...
Review changes made since 0.3.8 [here](https://github.com/last-wave/youtube-webos/blob/main/CHANGELOG.md)
...
![Segment Skipped](https://github.com/last-wave/youtube-webos/blob/main/screenshots/2_sm_new.png?raw=true)
...
- Use [webOS Homebrew Channel](https://github.com/webosbrew/webos-homebrew-channel) - app is available via repo link: https://raw.githubusercontent.com/last-wave/youtube-webos/main/repo.json
- Use [Device Manager app](https://github.com/webosbrew/dev-manager-desktop) - see [Releases](https://github.com/last-wave/youtube-webos/releases) for a
...
```sh
git clone https://github.com/last-wave/youtube-webos.git
```
